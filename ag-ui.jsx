...
const GAMES_DATA = [
  ...
  { id:'campos_dorados',    title:'Campos Dorados',    cat:'action',   catLabel:'Acción',     emoji:'🌾', bg:'#2d220a', accent:'#e0b04a', plays:'NUEVO',rating:4.9, desc:'Aventura 3D: explora la pradera, compra armas y ropa en el puerto de Bahía Serena, enciende 5 santuarios y vence al Guardián del Trigo' },
];
